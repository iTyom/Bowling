      ...
      <div class="row content">
        ...
        <div class="col-sm-6 text-center">
          ...
          <div class="well cadre_droite">
            ...
            <img src="images/Anniversaire.jpg" width=200/>
          </div>
        </div>
      </div>
        <!--Bloc Entreprise-->
        <div class="col-sm-12">
        <!--Bloc de gauche-->
        <div class="col-sm-3 cadre_gauche">
          <br><br>
          <div class="well cadre_gauche">
          <img src="images/Entreprise.jpg" width=200/>
          </div>
        </div>
        <!--Bloc de droite-->
        <div class="col-sm-9 text-left">
        <h1>Soirées entreprises</h1>
